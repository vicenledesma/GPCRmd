...
def get_variant_impact_param_weights_fitted_ab_escape(filename):
    weights_path_pre="/var/www/protwis/sites/files/Precomputed/covid19/variant_impact/param_weights/"
...
def load_mutated_isolates_in_finalprot(finprot):
    finp_iso_path="/var/www/protwis/sites/files/Precomputed/covid19/finprot_to_isolates"
...
#    mut_impact_path="/var/www/protwis/sites/files/Precomputed/covid19/variant_impact/mut_impact/dyn_%s.data" % dyn_id
#    if os.path.isfile(mut_impact_path):
#        with open(mut_impact_path,"rb") as fh:
#            mut_impact_d=pickle.load(fh)
        

    impact_per_variant_path_pre="/var/www/protwis/sites/files/Precomputed/covid19/variant_impact/summary"
...
def ajax_variant_impact(request):
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.POST:
        ...
        var_input_res_path="/var/www/protwis/sites/files/Precomputed/covid19/variant_impact/"
...
def download_varimpact(request,dyn_id,traj_id,position,analysis):
    var_input_res_path="/var/www/protwis/sites/files/Precomputed/covid19/variant_impact/%s/" % analysis
    if analysis=="rmsf":
...
def home(request):    
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' :
        context={}
        input_path="/var/www/protwis/sites/files/Covid19Data/Data/tree.data"
        ...
        genomes_d={}
#        genome_muts_path="/var/www/protwis/sites/files/Covid19Data/Data/home_genome_muts.data"
