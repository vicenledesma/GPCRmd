...
class DyndbSubmissionModel(models.Model):
    submission_id = models.OneToOneField('DyndbSubmission', models.DO_NOTHING, db_column='submission_id', blank=True, null=True, on_delete=models.CASCADE)
...
class DyndbFilesModel(models.Model):
    id_model = models.OneToOneField('DyndbModel', models.DO_NOTHING, db_column='id_model', on_delete=models.CASCADE)
    id_files = models.OneToOneField('DyndbFiles', models.DO_NOTHING, db_column='id_files', on_delete=models.CASCADE)
...
class DyndbFilesMolecule(models.Model):
    ...
    id_molecule = models.ForeignKey('DyndbMolecule', models.DO_NOTHING, db_column='id_molecule', null=True)
    id_files = models.OneToOneField('DyndbFiles', models.DO_NOTHING, db_column='id_files', null=True, on_delete=models.CASCADE)
