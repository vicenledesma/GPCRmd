...
class DyndbFilesModel(models.Model):
    id_model = models.OneToOneField('DyndbModel', models.DO_NOTHING, db_column='id_model')
    id_files = models.OneToOneField('DyndbFiles', models.DO_NOTHING, db_column='id_files')
