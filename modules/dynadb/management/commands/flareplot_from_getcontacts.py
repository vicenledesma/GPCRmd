...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        def create_pos_to_gnum(dyn_id):
            gcdata_path="/var/www/protwis/sites/files/Precomputed/get_contacts_files/dynamic_symlinks/dyn%(dynid)s/dyn%(dynid)s_labels.tsv" % {"dynid" :dyn_id}
        ...
        def create_p_jsons(dynfiles_traj,pos_to_gnum):
            ...
            gcdata_path="/var/www/protwis/sites/files/Precomputed/get_contacts_files/dynamic_symlinks/dyn%(dynid)s/dyn%(dynid)s_dynamic.tsv" % {"dynid" :dynfiles_traj[0]["dyn_id"]}
